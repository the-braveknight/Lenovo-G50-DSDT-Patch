...
DefinitionBlock ("", "SSDT", 2, "hack", "hack", 0)
{
    ...
    External(_SB.PCI0.RP05.PEGP.SVID, FieldUnitObj)
    External(_SB.PCI0.RP05.PEGP.HVID, BuffObj)
    External(_SB.PCI0.RP05.PEGP.SDID, FieldUnitObj)
    External(_SB.PCI0.RP05.PEGP.HDID, BuffObj)
