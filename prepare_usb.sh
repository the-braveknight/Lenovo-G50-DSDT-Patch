...
# Compile SSDT-USB.dsl & SSDT-AMD.dsl, copy AML to CLOVER/ACPI/patched
echo "Compiling the SSDTs required for the installer..."
iasl -ve -p $BUILDDIR/SSDT-USB.aml ./hotpatch/SSDT-USB.dsl
iasl -ve -p $BUILDDIR/SSDT-AMD.aml ./hotpatch/SSDT-AMD.dsl
echo "copying SSDT-USB.aml & SSDT-AMD.aml to $CLOVER/ACPI/patched"
cp $BUILDDIR/SSDT-USB.aml $CLOVER/ACPI/patched
cp $BUILDDIR/SSDT-AMD.aml $CLOVER/ACPI/patched
