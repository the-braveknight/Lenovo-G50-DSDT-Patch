...
PRODUCTS=$(BUILDDIR)/SSDT-XOSI.aml $(BUILDDIR)/SSDT-USB.aml $(BUILDDIR)/SSDT-PNLF.aml $(BUILDDIR)/SSDT-PS2K.aml $(BUILDDIR)/SSDT-IGPU.aml $(BUILDDIR)/SSDT-HDEF.aml $(BUILDDIR)/SSDT-HDAU.aml $(BUILDDIR)/SSDT-AMD.aml $(BUILDDIR)/SSDT-BATT.aml
