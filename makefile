...
PRODUCTS=$(BUILDDIR)/SSDT-PS2K.aml $(BUILDDIR)/SSDT-HDAU.aml $(BUILDDIR)/SSDT-HDEF.aml $(BUILDDIR)/SSDT-PNLF.aml $(BUILDDIR)/SSDT-XOSI.aml $(BUILDDIR)/SSDT-GPRW.aml $(BUILDDIR)/SSDT-BATT.aml $(BUILDDIR)/SSDT-USB.aml $(BUILDDIR)/SSDT-AMD.aml $(BUILDDIR)/SSDT-IGPU.aml
